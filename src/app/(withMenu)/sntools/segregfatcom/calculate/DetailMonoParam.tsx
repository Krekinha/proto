...
export default function DetailMonoParam() {
  const { openTab, setOpenTab, selectedNfe, prdMonoParam } =
                ...
                prdMonoParam.map((prod, index) => (
                  <tr key={index}>
                    ...
                    <td className="pl-2 py-2 border-b border-gray-400 bg-gray-300 text-center">
                      <p
                        title={
                          prod.isMonofasico === true
                            ? "Item confirmado como Monofásico conforme tabela vigente"
                            : "Item não pode ser confirmado como Monofásico em pesquisa por NCM, cabendo ao lojista confirmar sua parametrização"
                        }
                        className={`${
                          prod.isMonofasico === true
